...
const ReportsTable = () => {
  ...
  const fetchReports = async () => {
    ...
    try {
      ...
      setReports(data);
      setFilteredReports(data); // Initialize filteredReports

      // Scroll to top after fetching reports
  ...
  const handleSearch = (event) => {
    ...
    if (!query) {
      setFilteredReports(reports); // Show all reports if search query is empty
    } else {
